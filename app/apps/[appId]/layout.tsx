      ...
      <div className="mx-auto flex min-h-full w-full max-w-[1920px] items-start">
        <div className="min-w-0 flex-1">
          <header className="sticky top-0 z-30 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl">
            ...
            <div className="overflow-x-auto border-t border-slate-100 px-4 py-2 xl:hidden">
          ...
          <div className="flex min-h-[calc(100vh-4rem)] w-full items-start">
            <aside className="sticky top-16 hidden h-[calc(100vh-4rem)] w-60 shrink-0 flex-col border-r border-slate-200/70 px-4 py-7 xl:flex">
            ...
            <main className="min-w-0 flex-1 px-5 py-6 sm:px-8 sm:py-8 xl:px-8 xl:py-10 2xl:px-10">
              {children}
            </main>
          </div>
        </div>
